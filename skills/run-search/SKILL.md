...
4. Read the full description. Tailor a resume and answers from approved templates. Preserve exact files, hashes and source mappings. Check facts, extraction, reading order and writing. Record the checks with `vet`; a failed check ends the attempt.
